class SimpleLightbox {
    ...
    this.fadeOut(
      ...
      () => {
        ...
        if (this.options.htmlClass && this.options.htmlClass !== "") {
          document
            .querySelector("html")
            .classList.remove(this.options.htmlClass);
        }
  ...
  preload() {
    let index = this.currentImageIndex,
      ...
      next =
        index + 1 < 0 ? length - 1 : index + 1 >= length - 1 ? 0 : index + 1,
      prev =
        index - 1 < 0 ? length - 1 : index - 1 >= length - 1 ? 0 : index - 1,
      nextImage = new Image(),
      prevImage = new Image();
    ...
    nextImage.addEventListener("load", (event) => {
      ...
      this.relatedElements[index].dispatchEvent(
        new Event("nextImageLoaded." + this.eventNamespace)
      );
    });
    ...
    prevImage.addEventListener("load", (event) => {
      ...
      this.relatedElements[index].dispatchEvent(
        new Event("prevImageLoaded." + this.eventNamespace)
      );
    });
  ...
  loadImage(direction) {
    ...
    this.relatedElements[this.currentImageIndex].dispatchEvent(
      new Event((direction === 1 ? "next" : "prev") + "." + this.eventNamespace)
    );
  ...
  adjustImage(direction) {
    ...
    tmpImage.addEventListener("error", (event) => {
      this.relatedElements[this.currentImageIndex].dispatchEvent(
        new Event("error." + this.eventNamespace)
      );
      this.isAnimating = false;
      this.isOpen = true;
    ...
    tmpImage.addEventListener("load", (event) => {
      if (typeof direction !== "undefined") {
        this.relatedElements[this.currentImageIndex].dispatchEvent(
          new Event("changed." + this.eventNamespace)
        );
        this.relatedElements[this.currentImageIndex].dispatchEvent(
          new Event(
      ...
      if (
        this.loadedImages.indexOf(this.currentImage.getAttribute("src")) === -1
      ) {
      ...
      if (typeof this.options.captionSelector === "string") {
        captionContainer =
          this.options.captionSelector === "self"
        ...
        captionContainer = this.options.captionSelector(
          this.relatedElements[this.currentImageIndex]
        );
      }
      ...
      if (!this.options.loop) {
        ...
        if (this.relatedElements.length === 1) {
          this.hide(
            this.domNodes.navigation.querySelectorAll(".sl-prev, .sl-next")
          );
        } else {
          this.show(
            this.domNodes.navigation.querySelectorAll(".sl-prev, .sl-next")
  ...
  addEvents() {
    ...
    if (this.options.scrollZoom) {
      ...
      this.addEventListener(
        ...
        (event) => {
          if (
            this.controlCoordinates.mousedown ||
            this.isAnimating ||
            this.isClosing ||
            !this.isOpen
          ) {
          ...
          if (this.controlCoordinates.containerHeight == 0) {
            this.controlCoordinates.containerHeight = this.getDimensions(
              this.domNodes.image
            ).height;
            this.controlCoordinates.containerWidth = this.getDimensions(
              this.domNodes.image
            ).width;
            this.controlCoordinates.imgHeight = this.getDimensions(
              this.currentImage
            ).height;
            this.controlCoordinates.imgWidth = this.getDimensions(
              this.currentImage
            ).width;
            this.controlCoordinates.containerOffsetX =
              this.domNodes.image.offsetLeft;
            this.controlCoordinates.containerOffsetY =
              this.domNodes.image.offsetTop;

            this.controlCoordinates.initialOffsetX = parseFloat(
              this.currentImage.dataset.translateX
            );
            this.controlCoordinates.initialOffsetY = parseFloat(
          ...
          this.controlCoordinates.pinchOffsetY =
            event.pageY - scrollTopPos || 0; // need to substract the scroll position

          this.controlCoordinates.limitOffsetX =
            (this.controlCoordinates.imgWidth *
              this.controlCoordinates.targetScale -
              this.controlCoordinates.containerWidth) /
            2;
          this.controlCoordinates.limitOffsetY =
            (this.controlCoordinates.imgHeight *
              this.controlCoordinates.targetScale -
              this.controlCoordinates.containerHeight) /
            2;
          this.controlCoordinates.scaleDifference =
            this.controlCoordinates.targetScale -
            this.controlCoordinates.initialScale;
          this.controlCoordinates.targetOffsetX =
            this.controlCoordinates.imgWidth *
              this.controlCoordinates.targetScale <=
            this.controlCoordinates.containerWidth
              ? 0
              : this.minMax(
                  this.controlCoordinates.initialOffsetX -
                    ((this.controlCoordinates.pinchOffsetX -
                      this.controlCoordinates.containerOffsetX -
                      this.controlCoordinates.containerWidth / 2 -
                      this.controlCoordinates.initialOffsetX) /
                      (this.controlCoordinates.targetScale -
                        this.controlCoordinates.scaleDifference)) *
                      this.controlCoordinates.scaleDifference,
                  this.controlCoordinates.limitOffsetX * -1,
                  this.controlCoordinates.limitOffsetX
                );
          this.controlCoordinates.targetOffsetY =
            this.controlCoordinates.imgHeight *
              this.controlCoordinates.targetScale <=
            this.controlCoordinates.containerHeight
              ? 0
              : this.minMax(
                  this.controlCoordinates.initialOffsetY -
                    ((this.controlCoordinates.pinchOffsetY -
                      this.controlCoordinates.containerOffsetY -
                      this.controlCoordinates.containerHeight / 2 -
                      this.controlCoordinates.initialOffsetY) /
                      (this.controlCoordinates.targetScale -
                        this.controlCoordinates.scaleDifference)) *
                      this.controlCoordinates.scaleDifference,
                  this.controlCoordinates.limitOffsetY * -1,
                  this.controlCoordinates.limitOffsetY
                );

          this.zoomPanElement(
            this.controlCoordinates.targetOffsetX + "px",
            this.controlCoordinates.targetOffsetY + "px",
            this.controlCoordinates.targetScale
          );
          ...
          if (this.controlCoordinates.targetScale > 1) {
            ...
            if (
              (!this.domNodes.caption.style.opacity ||
                this.domNodes.caption.style.opacity > 0) &&
              this.domNodes.caption.style.display !== "none"
            ) {
          ...
          this.controlCoordinates.initialPinchDistance =
            this.controlCoordinates.targetPinchDistance;
          this.controlCoordinates.initialScale =
            this.controlCoordinates.targetScale;
          this.controlCoordinates.initialOffsetX =
            this.controlCoordinates.targetOffsetX;
    ...
    this.addEventListener(
      ...
      (event) => {
        ...
        if (event.type === "mousedown") {
          ...
          this.controlCoordinates.initialPointerOffsetX =
            event.touches[0].clientX;
          this.controlCoordinates.initialPointerOffsetY =
          ...
          if (this.controlCoordinates.touchCount === 1) {
            /* Single touch */ if (!this.controlCoordinates.doubleTapped) {
            ...
            /* Pinch */ this.controlCoordinates.initialPointerOffsetX2 =
              event.touches[1].clientX;
            this.controlCoordinates.initialPointerOffsetY2 =
            ...
            this.controlCoordinates.pinchOffsetX =
              (this.controlCoordinates.initialPointerOffsetX +
                this.controlCoordinates.initialPointerOffsetX2) /
              2;
            this.controlCoordinates.pinchOffsetY =
              (this.controlCoordinates.initialPointerOffsetY +
                this.controlCoordinates.initialPointerOffsetY2) /
              2;
            this.controlCoordinates.initialPinchDistance = Math.sqrt(
              (this.controlCoordinates.initialPointerOffsetX -
                this.controlCoordinates.initialPointerOffsetX2) *
                (this.controlCoordinates.initialPointerOffsetX -
                  this.controlCoordinates.initialPointerOffsetX2) +
        ...
        if (this.transitionCapable) {
          this.controlCoordinates.imageLeft = parseInt(
            this.domNodes.image.style.left,
            10
          );
        }
        ...
        this.controlCoordinates.swipeStart =
          event.pageX || event.touches[0].pageX;
        this.controlCoordinates.swipeYStart =
    ...
    this.addEventListener(
      ...
      (event) => {
        ...
        if (event.type === "touchmove") {
          ...
          if (this.controlCoordinates.touchCount > 1) {
            /* Pinch */ this.controlCoordinates.pointerOffsetX2 =
              event.touches[1].clientX;
            this.controlCoordinates.pointerOffsetY2 = event.touches[1].clientY;
            this.controlCoordinates.targetPinchDistance = Math.sqrt(
              (this.controlCoordinates.pointerOffsetX -
                this.controlCoordinates.pointerOffsetX2) *
                (this.controlCoordinates.pointerOffsetX -
                  this.controlCoordinates.pointerOffsetX2) +
            ...
            if (
              ...
              /* Initialize helpers */
              this.controlCoordinates.targetScale = this.minMax(
                (this.controlCoordinates.targetPinchDistance /
                  this.controlCoordinates.initialPinchDistance) *
                  this.controlCoordinates.initialScale,
                1,
            ...
            if (
              Math.abs(this.controlCoordinates.targetOffsetX) ===
              Math.abs(this.controlCoordinates.limitOffsetX)
            ) {
              this.controlCoordinates.initialOffsetX =
                this.controlCoordinates.targetOffsetX;
              this.controlCoordinates.initialPointerOffsetX =
            ...
            if (
              Math.abs(this.controlCoordinates.targetOffsetY) ===
              Math.abs(this.controlCoordinates.limitOffsetY)
            ) {
              this.controlCoordinates.initialOffsetY =
                this.controlCoordinates.targetOffsetY;
              this.controlCoordinates.initialPointerOffsetY =
        ...
        if (!this.controlCoordinates.zoomed) {
          this.controlCoordinates.swipeEnd =
            event.pageX || event.touches[0].pageX;
          this.controlCoordinates.swipeYEnd =
            event.pageY || event.touches[0].pageY;
          this.controlCoordinates.swipeDiff =
            this.controlCoordinates.swipeStart -
            this.controlCoordinates.swipeEnd;
          this.controlCoordinates.swipeYDiff =
            this.controlCoordinates.swipeYStart -
            this.controlCoordinates.swipeYEnd;
          if (this.options.animationSlide) {
      ...
      (event) => {
        if (this.isTouchDevice && event.type === "touchend") {
          ...
          if (this.controlCoordinates.touchCount === 0) {
            ...
            /* Single touch */ this.controlCoordinates.initialPointerOffsetX =
              event.touches[0].clientX;
            this.controlCoordinates.initialPointerOffsetY =
              event.touches[0].clientY;
          } else if (this.controlCoordinates.touchCount > 1) {
            /* Pinch */ this.controlCoordinates.initialPinchDistance = null;
          }
        }
        ...
        if (this.controlCoordinates.mousedown) {
          ...
          if (!this.options.loop) {
            ...
            if (
              this.currentImageIndex >= this.relatedElements.length - 1 &&
              this.controlCoordinates.swipeDiff > 0
            ) {
              possibleDir = false;
            }
          ...
          if (
            Math.abs(this.controlCoordinates.swipeDiff) >
          ...
          if (
            ...
            Math.abs(this.controlCoordinates.swipeYDiff) > 50 &&
            Math.abs(this.controlCoordinates.swipeDiff) <
              this.options.swipeTolerance
          ) {
            this.close();
    ...
    this.addEventListener(this.domNodes.image, ["dblclick"], (event) => {
      ...
      setTimeout(() => {
        if (this.currentImage) {
          this.currentImage.classList.remove("sl-transition");
          this.currentImage.style[this.transitionPrefix + "transform-origin"] =
            null;
        }
      }, 200);
  ...
  getRelated(rel) {
    ...
    if (rel && rel !== false && rel !== "nofollow") {
      elems = Array.from(this.elements).filter(
        (element) => element.getAttribute("rel") === rel
      );
    } else {
      elems = this.elements;
    }
  ...
  addEventListener(elements, events, callback, opts) {
    ...
    for (let element of elements) {
      ...
      for (let event of events) {
        ...
        let needsPassiveFix =
          ["touchstart", "touchmove", "mousewheel", "DOMMouseScroll"].indexOf(
            event.split(".")[0]
          ) >= 0;
